...
define Package/occupyhere/preinst
	#!/bin/sh
...
define Package/occupyhere/prerm
        #!/bin/sh
        # Revert-Changes
...
define  Package/occupyhere/postrm
        #!/bin/sh
...
define Package/occupyhere/install
...
$(eval $(call BuildPackage,occupyhere))
